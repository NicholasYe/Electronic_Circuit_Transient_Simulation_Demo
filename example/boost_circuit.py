...
End_time: float = 0.001  # Simulation presented end time


########## Circuit Component Parameter Setting

## Resistor
R1: Resistor = Resistor(R_name="R1", R_impedance=2)

## Inductor
L1: Inductor = Inductor(L_name="L1", L_impedance=0.000029, DeltaT=DeltaT)

## Capacitor
C1: Capacitor = Capacitor(C_name="C1", C_impedance=0.00004, DeltaT=DeltaT)

## Vsource
V1: DC_Voltage_Source = DC_Voltage_Source(V_name="V1", V_voltage=24, V_IR=0.00001)

## Switch
S1: Switch = Switch(S_name="S1", S_impedance=1.2, DeltaT=DeltaT, S_frequency=1/1000000, S_duty=0.5)

## Diode
D1: Diode = Diode(D_name="D1", D_impedance=1.2, D_character=1)
...
## Initialize Boost Connecting Matrix
boost_connect_matrix: dict = {
    "U1": {"U1": 0, "U2": ["L1"], "U3": 0, "U4": ["V1"]},
    "U2": {"U1": 0, "U2": 0, "U3": 0, "U4": ["S1"]},
    "U3": {"U1": 0, "U2": ["D1"], "U3": 0, "U4": ["C1", "R1"]},
    "U4": {"U1": 0, "U2": 0, "U3": 0, "U4": 0},
}

circuit_connect_matrix: dict = boost_connect_matrix
